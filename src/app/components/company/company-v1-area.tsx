            ...
            <div className="ms-xxl-5 ms-xl-3">
              ...
              {company_data.length === 0 && (
                <div className="text-center pt-60 pb-60">
                  <h4 className="fw-500">No companies found</h4>
                  <p className="m0">Company profiles will appear here soon.</p>
                </div>
              )}
              ...
              {company_data.length > 0 && (
                <div className="pt-50 lg-pt-20 d-sm-flex align-items-center justify-content-between">
                  <p className="m0 order-sm-last text-center text-sm-start xs-pb-20">
                    Showing <span className="text-dark fw-500">1 to {company_data.length}</span> of{" "}
                    <span className="text-dark fw-500">{company_data.length}</span>
                  </p>
                  <CompanyPagination/>
                </div>
              )}
